...
$langExInsertedAsModule = "has been added as a module of the $langsCourse and of this learning path";
...
$langLinkInsertedAsModule = "has been added as a module of the $langsCourse and of this learning path";
$langLogin = "Login";
...
$langUseOfPool = "This page allows you to view all the modules available in this $langsCourse. <br /> Any exercise or document that has been added in a learning path will also appear in this list.";
...
$langMediaAlreadyUsed = "Media already used in this learning path";
...
$langNodeAllowCourse2 = "(check whether $langsCourses can belong to faculty / department)";
...
$lang_course_multidep = "$langCourses can belong to multiple faculties/departments";
